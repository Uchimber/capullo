...
export default async function SuccessPage({
  ...
  const booking = await prisma.booking
    ...
    .catch((err) => {
      console.error(`SuccessPage DB error for ID ${bookingId}:`, err);
      return null;
    });
          ...
          <div className="space-y-8 relative z-10">
            ...
            <div className="space-y-4">
              <h2 className="text-3xl font-extrabold leading-tight">
                Захиалга
                <br />
                <span className="text-white/70 font-semibold">амжилттай</span>
              </h2>
              <p className="text-white/70 font-medium text-sm leading-relaxed">
                Төлбөр амжилттай төлөгдөж, таны захиалга баталгаажлаа.
                Баярлалаа!
              </p>
            </div>
          </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-base font-bold text-foreground capitalize">
                    {format(new Date(booking.startTime), "yyyy.MM.dd, EEEE", {
                      locale: mn,
                    })}
                  </p>
