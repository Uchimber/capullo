...
export default async function SuccessPage({
  ...
  try {
    ...
    if (!bookingId) {
      console.error('SuccessPage: bookingId is missing from params');
      return notFound();
    }
    ...
    console.error(`SuccessPage error for ID ${bookingId}:`, err);
    return (
      <div className="min-h-screen flex items-center justify-center bg-cream p-6 text-center">
        <div className="bg-white p-8 rounded-2xl shadow-lg border border-red-100 max-w-sm">
          <p className="text-red-500 font-bold mb-4">Уучлаарай, алдаа гарлаа.</p>
          <p className="text-sm text-dusty mb-6">Хуудсыг ачаалахад алдаа гарлаа. Гэхдээ таны төлбөр төлөгдсөн бол захиалга баталгаажсан байх болно.</p>
