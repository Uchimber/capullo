...
export default function Loading() {
  return (
    <div
      aria-live="polite"
      aria-busy="true"
      className="min-h-screen bg-cream flex flex-col items-center justify-center p-6 animate-in fade-in duration-1000 motion-reduce:animate-none"
    >
      <div className="relative group mx-auto w-32 h-32 mb-10">
         <div className="absolute inset-0 bg-mauve/40 rounded-[3rem] blur-3xl animate-pulse motion-reduce:animate-none" />
         <div className="relative w-32 h-32 bg-white rounded-[3rem] border-2 border-rose-soft/40 flex items-center justify-center shadow-2xl shadow-rose-soft/20 overflow-hidden">
           <div className="w-16 h-16 bg-blush/30 rounded-full flex items-center justify-center border border-rose-soft/20 animate-bounce motion-reduce:animate-none">
